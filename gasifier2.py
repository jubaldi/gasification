...
# special functions
#==============================================================================
def get_feed(fuelMix, moist=0, air=0, o2=0, stm=0):
    '''
    ...
    mw = np.fromiter(pp.Mw.values(), dtype=float)
...
def get_feed(self, moist=0, fuel=1.0, air=0, o2=0, stm=0):
    ...
    -------
    feed : object
        Cantera 'Mixture' object representing the mixture of phases in the feedstock.
    """
